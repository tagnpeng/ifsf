...
public class CDatBuild {
     ...
     * @return {@link ByteBuf }
     */
    public static ByteBuf nbProducts(int node, int sNode, int num) {
...
//        buf.release();
     ...
     * @return {@link ByteBuf }
     */
    public static ByteBuf nbFuellingModes(int node, int sNode, int num) {
        ByteBuf buf = Unpooled.buffer();
...
//        buf.release();
     ...
     * @return {@link ByteBuf }
     */
    public static ByteBuf nbFp(int node, int sNode, int num) {
        ByteBuf buf = Unpooled.buffer();
...
//        buf.release();
     ...
     * @return {@link byte[] }
     */
    public static ByteBuf standAloneAuth(int node, int sNode, int type) {
        ByteBuf buf = Unpooled.buffer();
